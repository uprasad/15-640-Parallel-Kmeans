...
time /usr/lib64/openmpi/bin/mpirun -np 5 -machinefile machines_transfer mpi_kmeans_dna DataGeneratorScripts/randomclustergen/dna1000x10x30 30 1000
time /usr/lib64/openmpi/bin/mpirun -np 5 -machinefile machines_transfer mpi_kmeans_dna DataGeneratorScripts/randomclustergen/dna1000x100x30 30 1000
time /usr/lib64/openmpi/bin/mpirun -np 5 -machinefile machines_transfer mpi_kmeans_dna DataGeneratorScripts/randomclustergen/dna1000x1000x30 30 1000
